...
## Part 1: Creating the Primary Amazon RDS Database (MariaDB)

### Step 1 – Click on the search box at the top of the AWS Management Console and type **"database"**.  
...
### Step 2 – Click **"Show more"** under the Services section.  
...
### Step 3 – In the expanded list, click **"Aurora and RDS"**.  
...
### Step 4 – On the RDS "Create database" page, choose your database engine.  
...
- Engine: MariaDB  
- Version: The guide used **MariaDB 11.4.5** (latest stable version at the time).  
...
### Step 12 – Choose your **Storage type**.  
...
### Step 14 – **Additional Storage Configuration** (very important):  
...
### Step 15 – **Availability & durability**:  
...
### Step 18 – Expand **Additional configuration**:  
...
### Step 20 – Scroll down and check **Enable encryption** (uses AWS KMS default key).
<img width="1362" height="765" alt="image" src="https://github.com/user-attachments/assets/bacbb69a-dbc3-4a6b-ba5e-d394315ccd4a" />

### Step 21 – At the very bottom, click the orange button **Create database**.
...
### Step 29 – **Additional storage configuration**:  
...
### Step 33 – Scroll to the bottom and click the orange **Create replica** button.
<img width="1362" height="765" alt="image" src="https://github.com/user-attachments/assets/062d78d5-205d-43bd-8e78-ad3798dd716e" />

### Step 34 – Wait a few minutes and refresh the Databases list.  
